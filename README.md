...
- Text editor with [Vim](https://www.vim.org/) and [Helix](https://helix-editor.com) enabled with the following
  ...
  - [`gopls`](https://github.com/golang/tools/blob/master/gopls/README.md): Go
  ...
  - [`ltex-ls`](https://github.com/valentjn/ltex-ls): Markdown/Typst
