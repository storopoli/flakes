...
in
{
  ...
  home.file = {
    "${config.xdg.configHome}/nvim/spell/en.utf-8.spl".source = vim-spell-en-utf8-dictionary;
    "${config.xdg.configHome}/nvim/spell/en.utf-8.sug".source = vim-spell-en-utf8-suggestions;
    "${config.xdg.configHome}/nvim/spell/pt.utf-8.spl".source = vim-spell-pt-utf8-dictionary;
  };
}
