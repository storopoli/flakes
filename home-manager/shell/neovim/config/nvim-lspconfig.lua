...
vim.api.nvim_create_autocmd("LspAttach", {
    ...
    callback = function(ev)
        ...
        vim.api.nvim_create_autocmd("BufWritePre", {
            ...
            callback = function()
                if vim.b.autoformat == false or not vim.b.autoformat then
                    return
                end
        ...
        vim.api.nvim_create_user_command('FormatToggle', function()
            ...
            print('Setting autoformatting to: ' .. tostring(vim.b.autoformat))
        end, {})
        vim.keymap.set({ "n", "v" }, "<leader>cf", "<CMD>FormatToggle<CR>", opts)
